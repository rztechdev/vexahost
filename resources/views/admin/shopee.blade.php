@extends('layouts.admin', ['title' => 'Proses Order Shopee', 'headerTitle' => 'Proses Order Marketplace Shopee'])
    ...
    <div class="bg-white rounded-lg border border-slate-200 p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2 mb-1">
                <span class="px-2 py-0.5 rounded text-xs font-semibold uppercase border border-slate-300 bg-slate-50 text-slate-900">Shopee Engine</span>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-5 py-3.5 text-right">
                                <div class="flex items-center justify-end gap-1.5">
                                    ...
                                    @if($so->invoice)
                                        <a href="{{ route('dashboard.invoice.print', $so->invoice->id) }}" target="_blank"
                                           class="px-2 py-1.5 text-slate-600 hover:text-slate-900 font-medium text-xs underline">
                                            Faktur
                                        </a>
                                    @endif
                                </div>
