...
/**
 * Penautan awal: seluruh akun yang sudah ada dikirim ke VexaHost WA Gateway.
 *
...
class TautkanAkunCommand extends Command
{
    ...
    protected $description = 'Tautkan seluruh akun yang sudah ada ke VexaHost WA Gateway (sekali jalan)';
