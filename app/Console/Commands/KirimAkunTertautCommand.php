...
/**
 * Mengulang pengiriman akun yang tertunda ke VexaHost WA Gateway.
 *
...
class KirimAkunTertautCommand extends Command
{
    ...
    protected $description = 'Kirim ulang perubahan akun yang belum sampai ke VexaHost WA Gateway';
